...
```
oc process -f https://raw.githubusercontent.com/pebcac/nextcloud-openshift/master/nextcloud.yaml -p NEXTCLOUD_HOST=nextcloud.example.com | oc -n $PROJECT create -f -
```
...
```
oc process -f https://raw.githubusercontent.com/pebcac/nextcloud-openshift/master/mariadb-backup.yaml | oc -n MYNAMESPACE create -f -
```
...
1. Fork it (https://github.com/pebcac/nextcloud-openshift/fork)
